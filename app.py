...
st.sidebar.title("The CHAT-BOT has the access to all these data :-")
st.sidebar.write("- Indian Constitution(Articles 1 - 395)")
st.sidebar.write("- Indian Penal Code, 1860 (IPC)")
st.sidebar.write("- Indian Evidence Act, 1872")
...
st.sidebar.write("- Limitation Act, 1963") # Example follow-up
st.sidebar.write("- Specific Relief Act, 1963")
st.sidebar.write("- Environment Protection Act, 1986")
st.sidebar.write("- Bharatiya Nyaya Sanhita, 2023")
st.sidebar.write("- Bharatiya Nagarik Suraksha Sanhita, 2023")
st.sidebar.write("- Bharatiya Sakshya Adhiniyam, 2023")
